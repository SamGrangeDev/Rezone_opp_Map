...
lyr_LGA_2.set('fieldAliases', {'fid': 'fid', 'LGA_NAME24': 'LGA_NAME24', 'STE_NAME21': 'STE_NAME21', 'Status': 'Status', 'GF/Infill': 'GF/Infill', });
lyr_LGA_2.set('fieldImages', {'fid': 'TextEdit', 'LGA_NAME24': 'TextEdit', 'STE_NAME21': 'TextEdit', 'Status': 'TextEdit', 'GF/Infill': 'Range', });
lyr_LGA_2.set('fieldLabels', {'fid': 'hidden field', 'LGA_NAME24': 'inline label - visible with data', 'STE_NAME21': 'inline label - visible with data', 'Status': 'inline label - visible with data', 'GF/Infill': 'inline label - visible with data', });
